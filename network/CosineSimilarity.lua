...
function cosines:updateGradInput(input,gradOutput)
	...
	-- block 2 backward pass. Conceptually the same as block 1 backward.
	...
	-- block 3 backward pass. Simple because W,X -> XW^T is linear in W,X.
	local g3X, g3W
	g3X = torch.mm(glwx,W)
	...
	-- I have tested it on some very small cases, where yeah, it does work fo sho 100%, 
	-- but you know. Use at your own risk.
